            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12">
                    ...
                    <div className="lg:col-span-7 p-12 lg:p-24 overflow-y-auto">
                        ...
                        <h2 className="text-6xl md:text-8xl font-black text-[var(--text-color)] mb-8 uppercase tracking-tight leading-none overflow-visible">
                            <span className="italic inline-block pr-12">{product.name}</span>
                        </h2>
                                        ...
                                        >
                                            <div className="flex flex-col md:flex-row gap-8 items-center">
                                                ...
                                                <div className="flex-1 text-center md:text-left">
                                                    <span className={`text-3xl md:text-4xl font-black block mb-2 uppercase transition-colors tracking-tight leading-none overflow-visible ${activeBenefits === item.name ? 'text-xnutra-neon' : 'text-[var(--text-color)]'}`}>
                                                        <span className="italic inline-block pr-8">{item.name}</span>
                                                    </span>
