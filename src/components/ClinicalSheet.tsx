                    ...
                    <div className="bg-[var(--panel-bg)] border-b border-[var(--border-color)] p-8 md:p-12 rounded-t-[4rem]">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <h2 className="text-5xl md:text-7xl font-black mb-4 tracking-tight text-[var(--text-color)] uppercase leading-none overflow-visible">
                                ...
                                {product.formulation.map((ingredient, index) => (
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-4">
                                            <h4 className="text-xl md:text-2xl font-black text-[var(--text-color)] uppercase tracking-tight flex-1 overflow-visible">
                                                <span className="italic inline-block pr-8">{ingredient.name}</span>
                                            </h4>
